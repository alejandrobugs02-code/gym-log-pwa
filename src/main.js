...
function renderAjustes() {
  ...
  return `
    ...
    <h2>Rutina</h2>
    <div class="card">
      <p class="small muted">La rutina viene del release <b>${esc(CATALOG.releaseId)}</b> del vault. Para cambiarla: edita el release y vuelve a correr <code>build-catalog.py</code>. Las sesiones ya registradas guardan su propia copia del plan, así que cambiar la rutina no altera el historial.</p>
